...
python -u $SCRATCH/offsets_testing_triwild/triwild-compute-wn/python_scripts/create_job_jsons.py -m $SCRATCH/offsets_testing_triwild/tagged_mshs_under_10mb
